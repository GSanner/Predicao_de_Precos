...
def buscar_categorias():
    carros = pd.read_parquet("C:/Users/guisa/Projetos/Predicao_de _Precos/app/data/carros.parquet")
...
def predicao_carros(caracteristicas):
    ...
    modelo = joblib.load("C:/Users/guisa/Projetos/Predicao_de _Precos/app/models/linear_model.pkl")
